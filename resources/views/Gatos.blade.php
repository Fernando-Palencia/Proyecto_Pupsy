...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/gato.css') }}">
...
<body>
    ...
    <div class="second-navbar">
        ...
        <div class="perros">GATOS</div>
    </div>
    <a href="https://chat.whatsapp.com/Fj3TyOxSCZUBkhhrMFqH9f" class="bi bi-whatsapp"></a>

    <img class="perro_img" src="img/gato.png" alt="Perra">

    <div class="contenedor">
        <div class="fila">
            <img src="img/accesoriosP.jpeg" class="imagen">
            <img src="img/medicamentosG.jpeg" class="imagen">
        </div>
        <div class="fila">
            <img src="img/juquetesG.jpeg" class="imagen grande">
        </div>
    </div>
